        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <?php } else { ?>
                        <td><a class="edit" href="updateHotels.php?id=<?php echo $row['hotel_id']; ?>"><i class="fa-sharp fa-solid fa-pen"></i></a>&emsp;<a class="delete" href="deleteHotels.php?id=<?php echo $row['hotel_id']; ?>"><i class="fa-solid fa-trash"></i></a></td>
                    <?php
                    }
                    ?>
                </tr>
