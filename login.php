...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($json->success == "true") {
        if ($stmt = $connection->prepare('SELECT admin_id, admin_password FROM `admin` WHERE email = ?')) {
    ...
    <div class="login">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="form-group mb-3">
                ...
                <input type="text" name="username" id="username" class="form-control" required autocomplete="off" placeholder="admin" />
            </div>
            ...
            <input type="submit" value="Sign in" class="btn btn-success mt-4 w-100"></button>
        </form>
    </div>
